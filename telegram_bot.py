...
baseUrl = "https://www.vinted.it/catalog?catalog[]=4&order=newest_first&brand_ids[]="
...
# TODO add commands for each brand?
...
async def add_query(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    #     return
    # query = query[0]
    query = f"{baseUrl}1043"

    print(f"Setting query for {query}")
